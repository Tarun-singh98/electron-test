...
export const fetchProfitLossFromTally = async (port: any, companyNameForTally: any, startDate: moment.MomentInput) => {
  console.time("fetchProfitLossFromTally");
  try {
    ...
    while (currentDate.isBefore(endDate) || currentDate.isSame(endDate, 'day')) {
      // console.log("running for year -------------> profitLoss");
    ...
    //QUARTER
    while (currentDate.isBefore(endDate) || currentDate.isSame(endDate, 'day')) {
      // console.log("running for quarter -------------> profitLoss");
    ...
    //MONTH
    while (currentDate.isBefore(endDate) || currentDate.isSame(endDate, 'day')) {
      // console.log("running for month -------------> profitLoss");
    ...
    console.timeEnd("fetchProfitLossFromTally");
    // console.log(arr);
    return arr;
  } catch (error: any) {

...
export const getAllStockItemsCategoryDataFromTally = async (port: any, companyNameForTally: any) => {
    try {
            ...
            <DESC>
                ...
                <TDL>
                    <TDLMESSAGE>
                        ...
                        <FIELD NAME="Fld05">
                            <SET>if $$IsEqual:$Parent:$$SysName:Primary then "" else $Guid:StockCategory:$Parent</SET>

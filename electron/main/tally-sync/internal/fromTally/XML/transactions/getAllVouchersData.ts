...
export const fetchCoreVouchersFromTally = async (port: any, companyName: any, startDate: any, syncConfigInfo: any) => {
    ...
    try {
        ...
        const fetchPeriodData = async (startDate: moment.Moment, endDate: moment.Moment) => {
            ...
            if (!response.ok) {
                return {
                    code: 400,
                    msg: "err fetching core voucher data from tally.",
                    err: response
                }
            }
            ...
            await new Promise(resolve => setTimeout(resolve, +syncConfigInfo.vouchers.intervalInMs));
        };
...
export const fetchAccountingDataFromTally = async (port: any, companyName: any, startDate: any, syncConfigInfo: any) => {
        ...
        for (let currentDate = moment(fromDate, "DD-MM-YYYY"); currentDate.isSameOrBefore(moment(toDate, "DD-MM-YYYY"), "day"); currentDate.add(+syncConfigInfo.vouchers.accounting, "days")) {
            ...
            if (!response.ok) {
                if (!response.ok) {
                    return {
                        code: 400,
                        msg: "err fetching accounting voucher data from tally.",
                        err: response
                    }
                }
            }
...
export const fetchVouchersInventoryDataFromTally = async (port: any, companyName: any, startDate: any, syncConfigInfo: any) => {
        ...
        const fetchPeriodData = async (startDate: moment.Moment, endDate: moment.Moment) => {
            ...
            if (!response.ok) {
                if (!response.ok) {
                    return {
                        code: 400,
                        msg: "err fetching inventory voucher data from tally.",
                        err: response
                    }
                }
            }
...
export const fetchVouchersBillDataFromTally = async (port: any, companyName: any, startDate: any, syncConfigInfo: any) => {
        ...
        const fetchPeriodData = async (startDate: moment.Moment, endDate: moment.Moment) => {
            ...
            if (!response.ok) {
                if (!response.ok) {
                    return {
                        code: 400,
                        msg: "err fetching bill voucher data from tally.",
                        err: response
                    }
                }
            }
